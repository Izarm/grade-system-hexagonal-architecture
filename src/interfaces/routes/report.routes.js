...
router.get('/students-list', authenticate, authorize(['adm in', 'docente']), controller.getStudentsList);
...
router.get('/bulk-report-cards', authenticate, authorize(['admin']), controller.generateBulkReportCards);
